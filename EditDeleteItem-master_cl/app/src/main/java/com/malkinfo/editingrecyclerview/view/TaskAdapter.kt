...
class TaskAdapter(val c:Context, val myPro:ArrayList<ProData>, val proList:ArrayList<ProData>):RecyclerView.Adapter<TaskAdapter.UserViewHolder>()
{
                    ...
                    R.id.select->{
                        ...
                        AlertDialog.Builder(c)
                            ...
                            .setPositiveButton("Yes"){
                                    dialog,_->
                                myPro.add(ProData(proList[adapterPosition].proName,proList[adapterPosition].proEmail, proList[adapterPosition].proDescription ))
                                println(myPro)
                                proList.removeAt(adapterPosition)
    ...
    override fun onBindViewHolder(viewHolder: TaskAdapter.UserViewHolder, position: Int) {
        viewHolder.proName.text = proList[position].proName
        viewHolder.proEmail.text = proList[position].proEmail
        viewHolder.proDescription.text = proList[position].proDescription
    }
