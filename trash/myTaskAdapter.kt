...
):RecyclerView.Adapter<myTaskAdapter.UserViewHolder>()
{
...
//                                Log.d("debug", "CHECKING UID_________________"+user.UID)
//                                mdatabase.child("Users").get().addOnSuccessListener {
//                                    for (u in it.children){
//                                       if (user.UID == u.child("uid").value.toString()){
//                                            mdatabase.child("Users").child(u.toString()).child("myPros").child("myPro"+adapterPosition.toString()).setValue( myProData(
...
//                                           )
//                                       }
                                        Log.d("debug", "CHECKING UID"+user.UID)
